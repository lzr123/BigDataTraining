...
from Spark.settings import SPARK_HOST_ADDR, SPARK_HOST_PORT, mysql_conn_param, SPARK_MASTER_ADDR, SPARK_MASTER_PORT
...
def main(argv):
    ...
    filepath = create_filepath(video_type_code, 'video_details/video_info_type')
